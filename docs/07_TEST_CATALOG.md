...
최종 확인: 2026-08-27
실행 기준: `python -m pytest --collect-only -q` → **145건**
...
| 구성 | 수량 | 설명 |
|---|---:|---|
| 일반 테스트 함수 | 141 | 함수 하나가 Pytest 실행 1건 |
| 파라미터 테스트 함수 | 1 | 아래 5개 Trial 결과를 각각 독립 실행 |
| 합계 | **145** | 현재 Pytest 수집 수 |
...
## 1. SRS·Agent 1·Checkpoint 1 (23건)
